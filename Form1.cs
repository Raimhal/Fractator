    ...
    public partial class FractalForm : Form
    {
        ...
        private void FractalsList_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (FractalsList.SelectedIndex == 0)
            {
                ...
                FractalsInfo.Text = info.Info(); // add info about the Mandelbrot set
                hx = -0.6;
                hy = 0;
                maxZ = 4;
        ...
        public void DrawFractals()
        {
            ...
            if(Progress.Maximum != Progress.Width && MinBranchLenght.Value > 10)
            {
        ...
        private async void DrawMBrot()
        {
            ...
            MBrotSet MBrotSet = new MBrotSet((Bitmap)pictureMBrotSet, pixels, tmpPixels, size, gradientForm.pictureGradient, (int)Iterations.Value);
